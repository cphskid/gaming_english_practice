...
ICONS = [
    ...
    ('first-live', 'sword-clash', 'lorc'),
    ('live-mates', 'crossed-sabres', 'lorc'),
    ('raid-slayer', 'crowned-skull', 'lorc'),
    ('raid-wins', 'shaking-hands', 'delapouite'),
    ('big-team', 'three-friends', 'delapouite'),
    ('raid-mates', 'meeple-group', 'delapouite'),
 ...
 *
 * 為什麼是內嵌的路徑資料不是 .svg 檔：五十一張各一到五 KB，內嵌省掉五十一個
